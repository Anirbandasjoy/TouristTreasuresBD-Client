...
const About = () => {
    ...
    return (
        <div className="mt-20 mb-40">
            <Helmet>
                <title>About | TouristTreasuresBD</title>
            </Helmet>
            <div className="flex flex-col lg:flex-row  justify-center gap-20 lg:gap-8 max-w-5xl mx-auto">
                <div className="flex-1 relative">
                    <img className="border-[1rem] w-full  rounded-md shadow-2xl border-white" src={about} alt="image" />
                    <img className="absolute w-3/4 sm:w-3/4 -bottom-20 rounded-md border-[.8rem] border-white -left-20" src={about2} alt="image2" />
                </div>
                <div className="flex-1 space-y-6 p-2">
                    <h3 className="text-sm lg:text-lg text-gray-400 font-bold">ABOUT TRAVIO</h3>
                    <h1 className="text-2xl font-bold text-[#061a3a] dark:text-gray-400 lg:text-5xl ">Bangladesh  <span style={{ color: 'red', fontWeight: 'bold' }}>
                    ...
                    <button onClick={() => navigate("/all-packages")} className=" p-4 px-6 text-white duration-700 font-semibold rounded-sm capitalize bg-[#ff7c5b] hover:bg-[#061a3a]">Find Packages</button>
