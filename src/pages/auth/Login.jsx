            ...
            <div className='flex h-screen items-center lg:w-2/4  w-full justify-center px-4 md:px-0 flex-1'>
                <div className="w-full max-w-lg p-4 border border-blue-400   rounded-md  sm:p-6 md:p-8 ">
                    <form className="space-y-6 " onSubmit={formik.handleSubmit}>
                        ...
                        <button type="submit" className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">{loading ? <FcOrgUnit size={20} className='animate-spin mx-auto' /> : "Login"} </button>
