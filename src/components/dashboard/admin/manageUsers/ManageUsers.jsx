                            ...
                            allUsers?.map((user) => {
                                return <tr key={user._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td className="px-6 lg:py-4  text-center">
                                        {
                                            user?.role === "Tourist" ? <button onClick={() => handleCreateGuide(user?._id)} className="bg-yellow-400 text-black lg:px-3 lg:py-2 text-xs w-14 lg:w-20 px-2 py-1">Guide</button> : <button disabled className="bg-yellow-200 cursor-not-allowed text-black lg:px-3 lg:py-2 text-xs w-14 lg:w-20 px-2 py-1">Guide</button>
                                        }
                                        {
                                            user?.role === "Tourist" ? <button onClick={() => handleCreateAdmin(user._id)} className="bg-blue-400 text-gray-200 lg:px-3 lg:py-2 text-xs w-14 lg:w-20 px-2 py-1">Admin</button> : <button disabled onClick={handleCreateAdmin} className="bg-blue-200 text-black cursor-not-allowed lg:px-3 lg:py-2 text-xs w-14 lg:w-20 px-2 py-1">Admin</button>
                                        }
                                    </td>
                                </tr>
